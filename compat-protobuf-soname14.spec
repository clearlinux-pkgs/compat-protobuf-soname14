...
Requires: compat-protobuf-soname14-lib = %{version}-%{release}
Requires: compat-protobuf-soname14-license = %{version}-%{release}
Requires: setuptools
Requires: six
...
%package license
Summary: license components for the compat-protobuf-soname14 package.
Group: Default

%description license
license components for the compat-protobuf-soname14 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568059083
...
export SOURCE_DATE_EPOCH=1568059083
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/compat-protobuf-soname14
cp LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname14/LICENSE
%make_install
...
rm -f %{buildroot}/usr/include/google/protobuf/stubs/atomicops_internals_atomicword_compat.h
...
/usr/share/package-licenses/compat-protobuf-soname14/LICENSE
